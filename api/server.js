...
// Create a JWT with a payload and sign it
const token = jwt.sign(user, secret, { expiresIn: '1h' });
console.log('JWT', token);

let DBMongo= "mongodb+srv://sakshamag277:saksham9927@@cluster0.xbellas.mongodb.net/queriesportal?retryWrites=true&w=majority"

// await mongoose.connect(DBMongo, {useNewUrlParser:true,useUnifiedTopology:true,});
